...
With a p-value of 1.77e-13 and less than $\alpha$ = 0.05, we reject the null hypothesis $H_0 = \beta_1$. We have enough evidence to suggest there is a significant time trend. There is an estimated 2.457 bu/acre increase in corn yield with each increasing year. 
