...
In the panel regression model, the p-value corresponding to coefficients for both mean temperature and mean square temperature are signficant (p-value < 2e-16). 
