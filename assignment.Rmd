...
winne_yieldtimeLM <- lm(yield ~ year, data = winne_yields)
summary(winne_yieldtimeLM)
...
#Plot average summer Tmax (x) and corn yield (y)
...
#Is adding covariates: year and Tmax^2 helpful? 
